...
const isEmbedded = (w) => String(w?.connectorType || '').toLowerCase() === 'embedded';

export function getPrimaryPrivyWallet(user, wallets) {
  ...
  return linked.find((a) => a?.type === 'wallet' && a?.address);
}
